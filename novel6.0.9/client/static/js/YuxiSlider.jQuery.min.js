    ...
    a.fn.extend({
        YuxiSlider:function(b){
            ...
            return a(this).each(function(){
                ...
                g=0,
                h=null,
                i='<div class="desc"><p class="title"><a href=""></a></p><span class="num"><em class="curr-num"></em><em class="line"></em><em class="total-num"></em></span></div><div class="bg"></div>';b.append(i);
                var j=a("p.title a",b),
                k=a("em.curr-num",b),
                l=a("em.total-num",b),
                m=0,
                ...
                p={
                    ...
                    touchend:function(a){
                        ...
                        0!==Math.abs(b)&&(
                            350>=e?p.moving(b):Math.abs(b)<=d.width/2?c.stop().animate({
